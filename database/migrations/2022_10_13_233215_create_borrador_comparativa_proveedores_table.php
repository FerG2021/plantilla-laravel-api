...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('borrador_comparativa_proveedores', function (Blueprint $table) {
            $table->increments('borrador_comparativa_proveedores_id');
            $table->integer('borrador_comparativa_id');
            $table->integer('presupuestacion_id');
            $table->integer('presupuestacion_proveedor_id');
    ...
    {
        Schema::dropIfExists('borrador_comparativa_proveedores');
    }
};
